...
osascript -e 'tell app "Terminal" to display dialog "DrsBee: Por favor espera mientras se instalan los componentes requeridos (Este proceso puede tardar varios minutos)"'
